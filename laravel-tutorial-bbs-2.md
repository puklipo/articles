...
「LaravelのFacadeなどの主要な機能はテストしやすくするためのもの」と思っていい。Laravelでコードを書く時は「テストできるかどうか」を常に考える。

### ヒント1
FacadeはLaravelを知らない人が勘違いしやすいこと第一位。Facadeはテストできるので何も問題はない。

FacadeがLaravel最大の特徴だったのは遥か昔Laravel4までの話。5.0以降は「FacadeがLaravelの特徴」なんて認識は持ってない。なので記事でもFacadeの説明はない。
